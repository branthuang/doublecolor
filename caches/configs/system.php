...
//Cookie配置
    ...
    'cookie_pre' => 'CXQHu_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
//附件相关配置
    ...
    'upload_url' => 'http://127.0.0.1:80/uploadfile/', //附件路径
    'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

    'js_path' => 'http://127.0.0.1:80/statics/js/', //CDN JS
    'css_path' => 'http://127.0.0.1:80/statics/css/', //CDN CSS
    'img_path' => 'http://127.0.0.1:80/statics/images/', //CDN img
    'app_path' => 'http://127.0.0.1:80/',//动态域名配置地址

    'b_js_path' => 'http://127.0.0.1:80/statics/assets/Scripts/', //额外 JS
    'b_css_path' => 'http://127.0.0.1:80/statics/assets/css/', //额外 CSS
    'b_img_path' => 'http://127.0.0.1:80/statics/assets/image/', //额外 img
    ...
    'gzip' => 1, //是否Gzip压缩后输出
    'auth_key' => 'pDuZB8NLgztNrgTy6egl', //密钥
    'lang' => 'zh-cn',  //网站语言包
    ...
    'phpsso' => '1',    //是否使用phpsso
    'phpsso_appid' => '12',    //应用id
    'phpsso_api_url' => 'http://127.0.0.1:8002/',    //接口地址
    'phpsso_auth_key' => 'ikdmY6lIYyheBRp4UIQmZMmx2UBGS7uE', //加密密钥
