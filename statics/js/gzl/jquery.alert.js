(function(a) {
    a.alerts = {
        ...
        alert2: function(b, c, d) {
            if (c == null) {
                c = "OK"
            }
            a.alerts._show(c, b, null, "alert2",
            function(e) {
                if (d) {
                    d(e)
                }
        ...
        //j:标题 b：内容 k:g：弹窗类型  m:回调 Lc:宽高 f:n:
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            switch (g) {
                ...
                case "openBox":
                    ...
                    a("#popup_message").append('<div id="popup_panel"><input type="button" value="' + a.alerts.okButton + '" id="popup_ok" /> <input type="button" value="' + a.alerts.cancelButton + '" id="popup_cancel" /></div>');
                    if (l) {
                        a("#popup_container").css({
                            width:
						l + "px"
    ...
    hiAlertSu = function(b, c, d) {
        a.alerts.alert2(b, c, d)
    };
