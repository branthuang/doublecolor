...
$LANG['correlative_setting'] = '相关系统管理';
$LANG['vote_setting'] = '投票配置';
$LANG['queue_del'] = '删除消息';
$LANG['admin_manage'] = '用户管理';
...
$LANG['content_settings'] = '内容相关系统管理';
...
$LANG['广告模板系统管理'] = '广告模板系统管理';
$LANG['poster_template'] = '广告模板系统管理';
...
$LANG['formguide'] = '动态表单管理';
$LANG['formguide_add'] = '添加动态表单管理';
$LANG['formguide_edit'] = '修改动态表单管理';
...
$LANG['video'] = '视频';
$LANG['video_setting'] = '相关系统管理';
$LANG['video_open'] = '申请开通';
$LANG['video_player_setting'] = '播放器系统管理';
...
$LANG['gzfmanage'] = '申请审核';
$LANG['shouli'] = '街道（镇）受理';
$LANG['chushen'] = '街道（镇）初审';
$LANG['fushen'] = '房管局复审';
$LANG['mz_fushen'] = '区民政部门复审';
$LANG['rending'] = '区房管局复审';
$LANG['module_manage1'] = '模块管理1';
$LANG['role_manage'] = '角色管理';
$LANG['release_point_management'] = '发布点管理';
$LANG['myindex'] = '工作台';
$LANG['statistics'] = '查询统计';
$LANG['inspect'] = '监查管理';
$LANG['streetapp'] = '受理申请审核';
$LANG['app_rules_set'] = '业务规则设置';
$LANG['apply_manage'] = '申请管理';
$LANG['list_public_field'] = '管理公共字段';
$LANG['appquery'] = '保障房申请查询';
$LANG['appstat'] = '保障房申请统计';
$LANG['viewwarning'] = '监察预警查询';
$LANG['complain'] = '用户投诉管理';
$LANG['app_batch_manage'] = '批次管理';
$LANG['holiday_set'] = '休息日设置';
$LANG['streetacceptlist'] = '审核申请列表';
$LANG['streetpublic'] = '街道公示列表';
$LANG['areahousingcheck'] = '区房管局汇总';
$LANG['citycheck'] = '市房管局复核认定';
$LANG['admin_add'] = '添加管理员';
$LANG['role_add'] = '添加角色';
$LANG['select_appbatch'] = '选择批次';
$LANG['second_publicity'] = '第二次公示';
$LANG['add_apply'] = '新增申请';
$LANG['cityapprove'] = '市房管局复核认定';
$LANG['edit_apply'] = '编辑申请';
$LANG['apply_detail'] = '查看申请';
$LANG['edit_user'] = '编辑共同申请人信息';
$LANG['user_detail'] = '查看共同申请人';
$LANG['del_user'] = '删除共同申请人';
$LANG['get_app_info'] = 'ajax请求申请信息';
$LANG['print_reply'] = '打印回执单';
$LANG['publicity_app_list'] = '可公示名单列表';
$LANG['add_publicity'] = '生成公示';
$LANG['publicity_detail'] = '查看公示';
$LANG['print_publicity'] = '打印公示';
$LANG['workflow_check'] = '工作流审核';
$LANG['common_expression'] = '日常用语';
$LANG['add_ce'] = '新增日常用语';
$LANG['edit_ce'] = '编辑日常用语';
$LANG['select_ce'] = '选择日常用语';
$LANG['delete_ce'] = '删除日常用语';
$LANG['publicity'] = '公示功能';
$LANG['export_publicity'] = '导出公示';
$LANG['image_upload'] = '附件上传';
$LANG['attachment_upload'] = '附件上传';
$LANG['select_picture'] = '选择图片';
$LANG['history_data_view'] = '历史表单数据查看';
$LANG['todo_info'] = '待办事项';
$LANG['cancel_apply'] = '撤销申请';
$LANG['change_apply_list'] = '变更申请列表';
$LANG['change_apply'] = '申请变更';
$LANG['change_apply_detail'] = '查看变更申请';
$LANG['auto_table_manage'] = '动态表管理';
$LANG['get_info'] = '查看监察预警';
$LANG['feedback'] = '监察预警反馈';
$LANG['get_complain_info'] = '查看投诉';
$LANG['complain_replay'] = '投诉回复';
$LANG['add_complain'] = '新增投诉';
$LANG['add_auto_table_value'] = '新增表数据';
$LANG['delete_auto_table_value'] = '删除动态表数据';
$LANG['interface_log'] = '省厅接口日志';
$LANG['house_appquery'] = '保障房搜索';
$LANG['house_senior_query'] = '保障房高级搜索';
$LANG['house_senior_query'] = '保障房高级搜索';
$LANG['house_query_export'] = '保障房搜索导出';
$LANG['house_stat'] = '保障房统计';
$LANG['house_stat_export'] = '保障房统计导出';
$LANG['init_holiday'] = '初始化休息日';
$LANG['save_holiday'] = '保存休息日';
$LANG['add_batch'] = '增加批次';
$LANG['delete_batch'] = '删除批次';
$LANG['edit_batch'] = '编辑批次';
$LANG['add_rule'] = '增加规则';
$LANG['delete_rule'] = '删除规则';
$LANG['edit_rule'] = '编辑规则';
$LANG['flowtest'] = 'flowtest';
$LANG['housing_xiecha'] = '房产信息协查';
$LANG['app_resource'] = '配租选房结果导入';
$LANG['apply_restart'] = '二次申请';
$LANG['blacklist'] = '黑名单管理';
$LANG['add_blacklist'] = '新增黑名单';
$LANG['edit_blacklist'] = '编辑黑名单';
$LANG['delete_blacklist'] = '删除黑名单';
$LANG['blacklist'] = '黑名单设置';
$LANG['add_blacklist'] = '增加黑名单';
$LANG['renbao_excel'] = '人保部门EXCEL处理';
$LANG['flow_check'] = '流程监控';
$LANG['app_rescore_import'] = '保障房源导入';
$LANG['app_resource_list'] = '保障房源列表';
$LANG['app_result_import'] = '选房结果导入';
$LANG['apply_restart'] = '重新生成申请';
?>